module AmazingStore::Spree::Image::MyPaperclipAttachment
  ...
  included do
    ...
    has_attached_file :attachment,
                      styles: Spree::Config.product_image_styles.map{|style, dim| [style, [dim, :png]]}.to_h,
                      default_style: Spree::Config.product_image_style_default,
                      default_url: 'noimage/:style.png',
                      url: '/spree/products/:id/:style/:basename.:extension',
                      path: ':rails_root/public/spree/products/:id/:style/:basename.:extension',
                      source_file_options: { all: "-quality 40" },
                      convert_options: { all: '-strip -colorspace sRGB -rotate 180 -gravity Center', mini: '-background blue -extent 40x40' }
